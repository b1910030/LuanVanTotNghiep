        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-sm-push-4">
                    ...
                    @foreach ($tour->departures as $other_day)
                      <div class="collection-wrap" id="list_tour">
                          <div class="thumbnail block-tour horizontal shadow cb">
                              <div class="img-tour">
                                  <a href="{{ route('detail', $other_day->id) }}" title="{{$tour->name}}" title="">
                              ...
                              <div class="info-tour">
                                  <div class="caption">
                                      <a class="title-tour" href="{{ route('detail', $other_day->id) }}" title="{{$tour->name}}">{{$tour->name}}</a>
                                      
                                      <p><i class="fa fa-clock-o"></i>
                                          <span>{{ $other_day->departure_day }}</span></p>             
                                      
                                      <p>
                                          <i class="fa fa-users" aria-hidden="true"></i>
                                          <span>Số chỗ còn nhận: {{ $other_day->quantity}}</span>
                                      </p>
                                      <p>
                                  ...
                                  <div class="bottom ">
                                      ...
                                      <span>{{ number_format($other_day->adult, 0) }} vnđ</span>
                                      <a href="{{ route('checkout', $other_day->id) }}" class="text-center btn btn-second">ĐẶT NGAY</a>
                                  </div>
                              </div>
                          </div>              
                      </div>
