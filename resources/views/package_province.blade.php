        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-sm-push-4">
                  <div class="seo-text"><h2 style="text-align:justify"><strong>{{$province->title}}</strong></h2>
                    <p style="text-align:justify">{{$province->description}}</p>
                  </div>
                    <br>
                    @foreach ($province->tours as $tour)
